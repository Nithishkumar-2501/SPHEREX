                ...
                <div className="card" key={teacher.id}>
                  ...
                  <div className="card-content-wrap">
                    ...
                    <div className="card-reveal-section">
                      ...
                      {/* Static Visual Mockup Icons (Non-clickable UI Preview) */}
                      <ul className="sci" aria-hidden="true">
                        <li>
                          <span className="icon-badge" title="Phone Calling Preview">
                        ...
                        <li>
                          <span className="icon-badge" title="Email Dispatch Preview">
                            <svg width={16} height={16} viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <li>
                          <span className="icon-badge" title="WhatsApp Messaging Preview">
                            <svg width={16} height={16} viewBox="0 0 24 24" fill="currentColor">
...
const StyledFacultyWrapper = styled.div`
  ...
  /* Visual mockup icons (.sci) - display only, non-clickable */
  .sci {
    display: flex;
    justify-content: center;
    align-items: center;
